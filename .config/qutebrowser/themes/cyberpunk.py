...
bg_default = "#091833"          # main shade darkest
bg_lighter = "#091833"
bg_selection = "#321959"
# "#545862"
fg_disabled = "#87afaf"
fg_default = "#0abdc6"
# "#b6bdca"
bg_lightest = "#373737"         # main shade lightest
fg_error = "#afaf5f5f"            # red
# "#d19a66"                     # orange
bg_hint = "#091833"             # yellow
fg_matched_text = "#0abdc6"     # green
bg_passthrough_mode = "#091833" # teal
bg_insert_mode = "#091833"      # blue
bg_warning = "#091833"          # purple
# "#be5046"                     # dark red
...
c.colors.downloads.bar.bg = bg_selection

# Color gradient start for download text.
c.colors.downloads.start.fg = "#fefefe"

# Color gradient start for download backgrounds.
c.colors.downloads.start.bg = bg_insert_mode

# Color gradient end for download text.
c.colors.downloads.stop.fg = "#fefefe"
