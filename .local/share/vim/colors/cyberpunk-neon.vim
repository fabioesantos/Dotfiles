...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Normal ctermbg=233 ctermfg=44 cterm=NONE guibg=NONE guifg=#0abdc6 gui=NONE
    ...
    hi SignColumn ctermbg=10 ctermfg=233 cterm=NONE guibg=#ea00d9 guifg=#000b1e gui=NONE
